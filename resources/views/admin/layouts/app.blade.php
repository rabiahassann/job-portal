...
<head>
  ...
  <link href="{!! asset('assets2/vendor/simple-datatables/style.')!!}" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">HaadiServices</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item{{ trim($__env->yieldContent('title')) === 'Dashboarrd' ? 'active' : '' }}">
        <a class="nav-link " href="{{ route('dashboard') }}">
          <i class="bi bi-grid"></i>
          <span>Dashboard</span>
        </a>
      </li><!-- End Dashboard Nav -->
      <li class="nav-item {{ trim($__env->yieldContent('title')) === 'Category' ? 'active' : '' }}" >
        <a class="nav-link collapsed" href="{{ route('showcategory') }}">
        <i class="bi bi-file-earmark-text-fill"></i>
          <span>Categorys</span>
        </a>
      </li><!-- End Profile Page Nav -->
      <li class="nav-item {{ trim($__env->yieldContent('title')) === 'Job' ? 'active' : '' }}">
        <a class="nav-link collapsed" href="{{ route('showjobs') }}">
  ...
  <script src="{!! asset('assets2s/vendor/echarts/echarts.min.js')!!}"></script>
